...
const tweet_models_1 = __importDefault(require("../database/models/tweet.models"));
const getTweetRepo = (tweetId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const tweet = yield tweet_models_1.default.findOne({ tweetId: tweetId });
        return tweet;
    }
    catch (error) {
        console.log(error);
...
const deleteTweetRepo = (tweetId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const deleted = yield tweet_models_1.default.findOneAndDelete({ tweetId: tweetId });
        if (deleted) {
            return true;
        }
        else {
...
const createTweetRepo = (tweet) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield tweet_models_1.default.create(tweet);
        return true;
    }
    catch (error) {
        console.log(error);
...
const updateTweetRepo = (tweetId, updatedTweet) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield tweet_models_1.default.findOneAndUpdate({ tweetId: tweetId }, updatedTweet, { new: true });
        if (result) {
            return true;
        }
        else {
