...
const getUserRepo = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield user_models_1.default.findOne({ uid: userId });
        return user;
    }
    catch (error) {
        console.log(error);
...
const deleteUserRepo = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const deleted = yield user_models_1.default.findOneAndDelete({ uid: userId });
        if (deleted) {
            return true;
        }
        else {
...
const createUserRepo = (user) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield user_models_1.default.create(user);
        return true;
    }
    catch (error) {
        console.log(error);
...
const updateUserRepo = (userId, updatedUser) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield user_models_1.default.findOneAndUpdate({ uid: userId }, updatedUser, { new: true });
        if (result) {
            return true;
        }
        else {
...
const updateUserWithTweetIdRepo = (userId, tweetId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield user_models_1.default.findOneAndUpdate({ uid: userId }, { $push: { tweets: tweetId } });
        if (result) {
            return true;
        }
        else {
